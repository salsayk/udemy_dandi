          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-8 mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-slate-900">GitHub Repository Summarizer</h2>
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-8">
                <div className="flex items-start gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500 mt-0.5">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <a 
                      ...
                      className="col-span-2 md:col-span-4 text-lg font-medium text-purple-600 hover:text-purple-700 flex items-center gap-2"
                    >
                    ...
                    <div className="bg-slate-50 rounded-xl p-3">
                      ...
                      <p className="font-semibold text-slate-900">{result.repository.forks.toLocaleString()}</p>
                    </div>
                    
                    <div className="bg-slate-50 rounded-xl p-3">
                      <p className="text-xs text-slate-500 mb-1">Language</p>
                      <p className="font-semibold text-slate-900">{result.repository.language || "N/A"}</p>
                    </div>
